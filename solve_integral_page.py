...
def solve_integral_page():
    ...
    lower_limit = st.text_input("Lower limit", value=0.0)
    lower_limit = float(sympify(preprocess_function_input(str(lower_limit))))
    upper_limit = st.text_input("Upper limit", value=1.0)
    upper_limit = float(sympify(preprocess_function_input(str(upper_limit))))
